...
class _$PageResponseImpl<T> implements _PageResponse<T> {
  ...
  @override
  String toString() {
    return 'PageResponse<$T>(content: $content, page: $page, size: $size, totalElements: $totalElements, totalPages: $totalPages, last: $last)';
  }
...
abstract class _PageResponse<T> implements PageResponse<T> {
  const factory _PageResponse(
      ...
      final int totalElements,
      final int totalPages,
      final bool last}) = _$PageResponseImpl<T>;
